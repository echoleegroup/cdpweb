...
var ChinaMobileAPI = (function (_super) {
    __extends(ChinaMobileAPI, _super);
    function ChinaMobileAPI(overviewService) {
        var _this = _super.call(this) || this;
        _this._overviewService = overviewService;
        return _this;
    }
    ChinaMobileAPI.prototype.init = function (router) {
        var _this = this;
        console.log('[IndexRoute::create] Creating Overview api route.');
        router.get('/china_mobile/social_posting/count', function (req, res, next) {
    ...
    ChinaMobileAPI.prototype.getSocialPostingCount = function (res, brand, series, geneType) {
        var _this = this;
    ...
    return ChinaMobileAPI;
}(API_Route_1.BaseApiRoute));
ChinaMobileAPI = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(di_types_1.TYPES.IOverviewService)),
    __metadata("design:paramtypes", [Object])
], ChinaMobileAPI);
exports.ChinaMobileAPI = ChinaMobileAPI;

//# sourceMappingURL=ChinaMobile.js.map
